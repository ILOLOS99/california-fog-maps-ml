...
Figures 3 and 4 use the included model-specific monthly prediction CSV files. These are derived from the corresponding `monthly_all_years.csv` model outputs, with station coordinates added.
